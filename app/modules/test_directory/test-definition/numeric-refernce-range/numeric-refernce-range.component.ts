...
@Component({
  selector: 'app-numeric-refernce-range',
  templateUrl: './numeric-refernce-range.component.html',
  styleUrls: ['./numeric-refernce-range.component.scss']
})
export class NumericRefernceRangeComponent {
  ...
  div:string='0';sect:string=''; testTd : string=''; testCode: string = '';
  constructor(private _numericReferenceRangeService: NumericRefernceRangeService, public _commonAlertService: CommonAlertService,) { }
  ...
  GetSect(event : any){  
    this._numericReferenceRangeService.getSectionByDivision(parseInt(event.target.value)).subscribe(res => {
  ...
  GetTestDirectiveByDiv(div : number){  
    this._numericReferenceRangeService.getAllTestDirectiveByDivision(div).subscribe(res => {
      this.tdModel = [];
      this.tdModel = res;
      if(this.sect != '')
  ...
  GetReferenceRangeData(): void {
    this._numericReferenceRangeService.getNumericReferenceRange().subscribe(res => {
  ...
  saveReferenceRange(){
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
          ...
          this._numericReferenceRangeService.saveNumericReferenceRange(this.selRRModel).subscribe((data : any) => {
            this.GetReferenceRangeData();
            if (data) {
