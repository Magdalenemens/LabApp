...
export class OrderentrynewService {
  ...
  GetMultipleSearch(IDNT: any, TEL: any, PAT_ID: any, PAT_NAME: any, DOB: any, SEX: any, ORD_NO: any, ACCN: any,MDL : any,FromDate :any=null,ToDate :any=null) {
    return this.http.get<any>(`${this.baseUrl}api/Order/GetMultipleSearch/${IDNT}/${TEL}/${PAT_ID}/${PAT_NAME}/${DOB}/${SEX}/${ORD_NO}/${ACCN}/${MDL}/${FromDate}/${ToDate}`);
  }
