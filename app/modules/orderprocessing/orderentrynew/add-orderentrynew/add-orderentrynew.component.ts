...
import { OrderentrynewService } from './orderentrynew.service';

@Component({
  selector: 'app-add-orderentrynew',
  templateUrl: './add-orderentrynew.component.html',
  styleUrls: ['./add-orderentrynew.component.scss']
})
export class AddOrderentrynewComponent implements OnInit {
  public PRTable: any[] = [];
  public barcode: any[] = [];
  public td_gt: any[] = [];
  public salesmen: any[] = [];
  ...
  otpid: string = '';
  natid: string = '';
  constructor(private fb: FormBuilder, private orderentryService: OrderentrynewService,
  ...
  */
  ...
  LoadPatient(paT_ID) {
    const PAT_IDEle = document.getElementById("PAT_ID") as HTMLInputElement;
    if (paT_ID) {
      PAT_IDEle.value = paT_ID
      this.OrderEntryForm.value.PAT_ID = paT_ID;
    }
